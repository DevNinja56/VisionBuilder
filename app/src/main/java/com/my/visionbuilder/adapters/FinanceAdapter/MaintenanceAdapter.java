...
public class MaintenanceAdapter extends RecyclerView.Adapter<MaintenanceAdapter.MyViewHolder>{
    ...
    private MaintenanceAdapter.OnItemClickListener mListener;
    ...
    public MaintenanceAdapter(Context context, ArrayList<Maintenance> list) {
    ...
    public MaintenanceAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MaintenanceAdapter.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.house_finance_item, parent, false));
    }
    public void onBindViewHolder(@NonNull final MaintenanceAdapter.MyViewHolder holder, final int position) {
