...
public class KidsAdapter extends RecyclerView.Adapter<KidsAdapter.MyViewHolder>{
    Context context;
    ArrayList<Kid> list;
    private KidsAdapter.OnItemClickListener mListener;
    public interface OnItemClickListener {
        void onItemClick(int position);
    }
    public void setOnItemClickListener(KidsAdapter.OnItemClickListener listener) {
        mListener = listener;
    }
    public KidsAdapter(Context context, ArrayList<Kid> list) {
    ...
    public KidsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new KidsAdapter.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.kids_item, parent, false));
    }
    public void onBindViewHolder(@NonNull final KidsAdapter.MyViewHolder holder, final int position) {
