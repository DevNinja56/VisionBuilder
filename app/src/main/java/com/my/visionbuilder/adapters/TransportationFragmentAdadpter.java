...
public class TransportationFragmentAdadpter extends FragmentStatePagerAdapter {
    Context context;

    public TransportationFragmentAdadpter(@NonNull FragmentManager fm, android.content.Context context) {
        super(fm);
