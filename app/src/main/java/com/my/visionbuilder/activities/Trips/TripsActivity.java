...
import com.my.visionbuilder.adapters.TripAdapters.TripFragmentAdapter;

public class TripsActivity extends AppCompatActivity {

    private ViewPager viewPager;
    private TabLayout tabLayout;
    TripFragmentAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new TripFragmentAdapter(getSupportFragmentManager(), getApplicationContext());
