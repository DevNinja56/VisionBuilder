package com.my.visionbuilder.activities.SavingPlan.BackToSchool;
...
public class BackToSchoolActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerview.setLayoutManager(new LinearLayoutManager(BackToSchoolActivity.this));
        recyclerview.setNestedScrollingEnabled(false);
        list = new ArrayList<SavingPlanTransaction>();
        adapter = new SavingPlanTransactionAdapter(BackToSchoolActivity.this, list, "EMERGENCY_FUND");
        recyclerview.setAdapter(adapter);
        loadSources();
        btn_Add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BackToSchoolActivity.this, AddSavingTransactionActivity.class);
