...
public class AutoPaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerview.setLayoutManager(new LinearLayoutManager(AutoPaymentActivity.this));
        recyclerview.setNestedScrollingEnabled(false);
        list = new ArrayList<Auto>();
        adapter = new AutoListAdapter(AutoPaymentActivity.this, list);
        recyclerview.setAdapter(adapter);
        loadSources();
        btn_Add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AutoPaymentActivity.this, AddAutoForPaymentActivity.class);
