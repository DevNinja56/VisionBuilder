...
public class YearlyGoalsFragment extends Fragment {

    RecyclerView yearly_GoalsRecyclerview;
    ArrayList<Goal> list;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_yearly_goals, container, false);
        yearly_GoalsRecyclerview = view.findViewById(R.id.yearly_GoalsRecyclerview);
        yearly_GoalsRecyclerview.setLayoutManager(new LinearLayoutManager(getActivity()));
        yearly_GoalsRecyclerview.setNestedScrollingEnabled(false);
        list = new ArrayList<Goal>();
        adapter = new GoalsAdapter(getActivity(), list);
        yearly_GoalsRecyclerview.setAdapter(adapter);
        loadGoals();
        return view;
    }
