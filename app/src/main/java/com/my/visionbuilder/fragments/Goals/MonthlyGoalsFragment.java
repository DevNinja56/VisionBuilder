...
public class MonthlyGoalsFragment extends Fragment {
    RecyclerView monthly_GoalsRecyclerview;
    ArrayList<Goal> list;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        monthly_GoalsRecyclerview = view.findViewById(R.id.monthly_GoalsRecyclerview);
        monthly_GoalsRecyclerview.setLayoutManager(new LinearLayoutManager(getActivity()));
        monthly_GoalsRecyclerview.setNestedScrollingEnabled(false);
        list = new ArrayList<Goal>();
        adapter = new GoalsAdapter(getActivity(), list);
        monthly_GoalsRecyclerview.setAdapter(adapter);
        loadGoals();
        return view;
    }
