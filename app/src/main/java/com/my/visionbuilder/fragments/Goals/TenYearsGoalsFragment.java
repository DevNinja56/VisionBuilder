...
public class TenYearsGoalsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ten_years_goals, container, false);
        ten_YearsGoalsRecyclerview = view.findViewById(R.id.ten_YearsGoalsRecyclerview);
